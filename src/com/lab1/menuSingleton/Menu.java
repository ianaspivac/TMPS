...
public class Menu {
    ...
    private Menu() {
        ...
        this.burgers = new Burger[]{BurgerClient.getBurger("miniChicken"), BurgerClient.getBurger("miniCheese"), BurgerClient.getBurger("chicken"), BurgerClient.getBurger("chilly"), BurgerClient.getBurger("shrimp"), BurgerClient.getBurger("cheese")};
